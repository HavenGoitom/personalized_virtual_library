<div class="panel auth" style="max-width:760px;margin:12px auto">
  <h3>Signup</h3>
  <form method="post" action="<?= BASE_PATH ?>/signup" style="margin-top:10px;display:grid;gap:12px">
    <input type="hidden" name="_csrf" value="<?= \App\Core\Csrf::token() ?>">
    <div class="form-row">
      <label>Display name</label>
      <input name="display_name" type="text" placeholder="How should we call you?" required>
    </div>
    <div class="form-row">
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;gap:8px;margin-top:6px">
      <a class="btn ghost" href="<?= BASE_PATH ?>/login">Login</a>
